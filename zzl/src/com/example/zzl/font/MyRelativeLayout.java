...
//
    ...
    private void init() {
        ...
        listTvParams = new ArrayList<TextViewParams>();
    ...
    public List<TextViewParams> getListTvParams() {
        List<TextViewParams> newImageList = new ArrayList<TextViewParams>();
        newImageList.addAll(listTvParams);
        return newImageList;
    }

    public void setListTvParams(List<TextViewParams> listTvParams) {
        List<TextViewParams> tempList = new ArrayList<TextViewParams>();
