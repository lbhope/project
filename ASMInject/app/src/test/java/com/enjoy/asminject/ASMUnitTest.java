...
public class ASMUnitTest {
    ...
    public void test() throws IOException {
         ...
         * 1、获得待插桩的字节码数据
         */
        FileInputStream fis = new FileInputStream("/Users/libin/Documents/gitproject/project/ASMInject/app/src/test/java/com/enjoy/asminject/InjectTest.class");
        ...
        FileOutputStream fos = new FileOutputStream("/Users/libin/Documents/gitproject/project/ASMInject/app/src/test/java/com/enjoy/asminject/InjectTest2.class");
        fos.write(bytes);
        fos.close();
    }
