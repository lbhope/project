...
import com.zero.materialdesign.base.animation.AlphaInAnimation;
import com.zero.materialdesign.base.animation.BaseAnimation;
import com.zero.materialdesign.base.animation.ScaleInAnimation;
import com.zero.materialdesign.base.animation.SlideInBottomAnimation;
import com.zero.materialdesign.base.animation.SlideInLeftAnimation;
import com.zero.materialdesign.base.animation.SlideInRightAnimation;
import com.zero.materialdesign.base.loadmore.CustomLoaderView;
import com.zero.materialdesign.base.loadmore.IExpandable;
import com.zero.materialdesign.base.loadmore.LoadMoreClickListener;
import com.zero.materialdesign.base.loadmore.LoadMoreView;
import com.zero.materialdesign.base.loadmore.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private LoadMoreView mLoadMoreView = new CustomLoaderView();
        ...
        if (getRecyclerView() == null) {
            ...
            mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    int mFirstVisibleItem = linearLayoutManager.findFirstVisibleItemPosition();
                    ...
                    if (mVisibleItemCount > 0 && lastVisibleItem >= mTotalItemCount-mPreLoadNumber) {
    ...
    public void loadMoreLoading() {
        ...
        mLoading = true;
        mLoadMoreView.setLoadMoreStatus(LoadMoreView.STATUS_LOADING);
        notifyItemRangeChanged(getHeaderLayoutCount() + mData.size() + getFooterLayoutCount(),1,"load");
    }
    ...
    public BaseQuickAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
        ...
        setHeaderAndEmpty(isKeepHeader());
    }
    ...
    /**
     * if need keep header when is empty status, shoule overide this method and return true
     */
    protected boolean isKeepHeader() {
        return false;
    }
            ...
            public void onClick(View v) {
                ...
                if (mLoadMoreView.getLoadMoreStatus() == LoadMoreView.STATUS_FAIL) {
                    if (loadMoreClickListener != null) {
                        loadMoreClickListener.loadMoreClick(mLoadMoreView.getLoadMoreStatus());
                    }
                    loadMoreLoading();
                }
            }
     ...
     */
    public boolean headerViewAsFlow, footerViewAsFlow;
...
//        autoLoadMore(positions);
    ...
    public void bindBitmapHolder(K holder,int position){
